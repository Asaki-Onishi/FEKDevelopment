...
[このリンク先から](https://github.com/Asaki-Onishi/FEKDevelopment/blob/master/fek_package_m2.tar.gz)ダウンロードし、/home/***（ユーザー）下に配置する。
```
mvコマンドで移動
...
<details><summary>3 . 監視パッケージの起動</summary>
